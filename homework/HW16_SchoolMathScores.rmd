...
It appears that to at least a moderate extent, the FARMS percentage and math test scores have a negative correlation. 
...
The p-value indicates that the relationship is statistically signficant and the adjust r-squared value being fairly moderate, which tells me I should look at the coefficents. The coefficents indicate that there is a negative relationship, which would be important to explore.
...
3 out of the top 5 schools are underperforming the model. The largest difference is around 30. For Fox Chapel Elementary it's interesting to see how evenly distributed Black, Hispanic, and White is in the zip code. For Broad Acres Elementary, the per capita income is incredibly low when compared to Fox Chapel.
...
The school board member's correlation is accurate in Montgomery county at least, but it's important for me to look into what factors contribute to the population of FARMS students.
