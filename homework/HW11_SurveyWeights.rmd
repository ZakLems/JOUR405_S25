...
Education levels in survey samples often differ from the general population because people without college degrees may be less likely to respond to surveys causing those with some college or college to be over represented.
...
College education may be key to raising voter turnout
...
# Create a more readable format# Q2_1Create a more readable format
...
The percentages for college and some college didn't significantly change while the intentions for high school or less changed by up to nearly 3 percentage points.  

2. Why might the weighted results be considered more accurate than the unweighted results?

The weighted results factor for the decreased response rates (and subsequently sample representation) of individuals with education levels high school or less.
...
High school or less shows the largest differences between weighted and unweighted results.
...
The visualization makes it a lot easier to see the differences between weighted and unweighted results. Being able to see the values right next to each otehr is really useful.
...
Individuals with a higher education level were more likely to intend to vote in November's election than those with lower education levels. In response to the question of whether or not they intended on voting in the election, 93.5% of respondents with a college education level chose yes compared to 85.1% and 70.8% for repsondents with some college and high school or less respectively. 

Weighting the survey results decreased the choice of "yes" by 2.7%, showing how much weighting can change the results of a survey. It also could be (ironically) indicative of the decreased participation of individuals in voting and surveys, the higher weight meaning that the group has a lower response rate. When interpreting polling results in news reporting, it's essential to consider whether or not the survey is weighted.
...
Journalists should understand survey weighting so they know whether or not the polls they're reporting on a representative of the population.

2. How might the differences between weighted and unweighted results affect how you would report on this data?
I would have to be explicit that the results I'm reporting on aren't weighted and may not be truly representative of the population.
...
I would like to know what resources the surveyors consulted to figure out the weights.
