...
I think the differences may be meaninfgul. Although the variation across categories isn't that great (the biggest difference being 20 for As and Cs), when combining all categories it's around a quarter worth of variation from the expected.
...
The chi-square statistic of 11.667 is greater than the critical value of 9.487729. This means that we can reject the null hypothesis and conclude that there is a statistically signficant difference between the observed value and expected value. 
...
Grade | Expected | Observed | Discrepancy
A | 80 | 100 | +20
B | 120 | 125 | +5
C | 120 | 100 | -20
D | 40 | 45 | +5
...
It's notable that higher grades (A and B) had a net increase whiel lower grades (D and F) had a net decrease. Following that I can infer (but not conclude) that the grades trended to be more positive than expected. I would ask the instructor/college if there has been any incentive or initiative recently enacted that aims to support or boost student performance.
