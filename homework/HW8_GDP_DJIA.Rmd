...
GDP |> ggplot() +
  ...
  ggtitle("Dow Jones vs GDP")
```

### Task 5: Describe our results

Write a few sentences about tshe relationship between the DJIA and GDP. Is there a strong correlation between the two variables? What does the scatterplot show?
There is a very strong correlation between GDP and DJIA. The scatter plot shows that increases in GDP correlate with increases in the Dow Jones Industrial Average.
