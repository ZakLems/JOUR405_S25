...
Scores have  improved. All of the new scores are above the previous mean.
...
As I determined in the previous question the average score has increased. But the standard deviation has also decreased, indicating a decrease in variance. This could mean that outlier students who may have been scoring higher under the previous program aren't anymore. I would look deeper into how the program may be standardizing learning in a way that prevents postiive outliers.
...
Reading Scores Under New Program Above Previous Average
...
'
The p-value tells us that we can't reject the null hypothesis and the results aren't statistically significant. For a non-technical audience we could say:
We can't confidently say that the superintendent's claim that the new program increased reading scores is true.
...
Analysis Shows New Reading Enrichment Program Ineffective

The school district's new reading program may not be as impactful as Superintendent [NAME] claimed. Despite a 4.3% improvement in reading scores a semester after the implementation of the program, an analysis of 12 third-grade classrooms shows that the increase cannot be directly linked to the new program. 


### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?

The reading level of students measured by the (for lack of a better word) density of the books they read.
