...
Rarely/Never voters who said they planned on voting decreased the most in the weighted results.

2. How might these differences affect reporting on likely voter turnout?
The differences show how volatile likely voter turnout can be and it's important to be clear when reporting on voter turnout.
...
These differences exist because the choices of under-represented groups are amplified by the weighting process. The results tell us that rarely/never voters are under-represented.
