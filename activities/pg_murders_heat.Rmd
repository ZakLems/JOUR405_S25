...
```{r}
murderTemps <- read_csv('https://raw.githubusercontent.com/dwillis/jour405/refs/heads/main/data/pg_murder_temps.csv')
```
...
```{r}
murderTemps |> summarize(correlation = cor(murders, temperature, method = "pearson"))
```
...
The results show that there is a moderate positive correlation between termperature and murders, with the highest amont of murders happening during the summer months. 
