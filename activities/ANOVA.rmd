...
Private schools have the highest average SAT followed by public and then community. The distance between the median scores for all types of colleges are similar to the distance between the mean scores. Community colleges have the highest standard deviation and range, followed by public and then private.
...
1. Based on the F-Value, there is a significant difference in SAT scores across college types.
2. All of the college types differ from each other but community colleges differ the most from the other two types.
3. On average, private schools have SAT scores ~367 point above community colleges while Public schools have SAT scores ~293 points above community colleges. Public schools average SAT scores ~74 points below private schools.

#Students atttending private colleges score higher on SAT
A recent data analysis shows that private college students score 74 point more on the SAT than public college students on average. Both types of institutions score average over 290 points above community colleges.
