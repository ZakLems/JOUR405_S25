...
A local neighborhood's increased property value could be linked to the activation of a new light rail line.

Based on property values obtained from the city, the average sale before the rail was $285,000. Recent sales from after the implementation show an average of $304,500, an increase of 6.8%. 
'
Analysis performed by [Publication] indicates the increase wasn't up to chance. Local officials directly link the increase to the rail.
