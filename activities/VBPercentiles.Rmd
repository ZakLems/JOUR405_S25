...
```{r}
teamAces |> mutate(percentile = ntile(total_aces, 100))
```
...
Maryland produced more service aces than 95% of other NCAA Women's volleyball teams. 5% of teams are better at producing service aces.
