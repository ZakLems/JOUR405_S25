...
For unusually high days I would draw the line around 17. For unusually low days I would draw the line around 5.
...
They're a lot more extreme than I suggested. My range was from 5-17 while the range based on the >2 Z-Score is 3-18.
...
Tuesday October 4, 2022, was three times further than the average distance from the average Tuesday call rate.
Tuesday October 4, 2022, was well above the average Tuesday call rate.
...
Some angles could be analyzing what's causes the three month spike in the average from February to May. For that getting more data from the past to see if there is a seasonal trend would be important. On the Z-Score front, the z-score for New Years 2023 was pretty high so maybe something on that. Also just general reporting during the summer where there are a lot of spikes could be interesting. 
