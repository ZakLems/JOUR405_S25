...
carThefts |> 
  ggplot() + 
  geom_histogram(aes(x = count), binwidth = 1.5) +
...
The distribution is skewed to the right because there is more data between the mean and one standard deviation above the mean than there is between the mean and one standard deviation below. 
